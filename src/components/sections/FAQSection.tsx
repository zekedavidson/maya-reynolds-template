...
const FAQSection = () => {
    ...
    return (
        <section className='w-full bg-[#FBF6F1] py-16 md:py-24'>
            <div className='grid grid-cols-1 md:grid-cols-[1.5fr_2fr] gap-40 items-start max-w-[1500px] mx-auto px-6 md:px-12 lg:px-16 2xl:px-20'>
                {/* Left: Flower Image */}
                ...
                <div className='flex flex-col gap-7 order-2 '>
                    <h2 className='text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl font-medium text-[#223614] mb-10 mt-32 2xl:mt-40 3xl:mt-50'>
                        FAQs
                    </h2>
                        ...
                        {faqData.map((faq, index) => (
                            <div key={index} className='border-t border-b border-[#223614]'>
                                ...
                                >
                                    ...
                                    <span className='text-xl md:text-2xl lg:text-5xl font-medium text-[#223614]'>
                                        {faq.question}
                                    </span>
