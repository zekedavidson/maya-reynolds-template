...
const FAQSection = () => {
    ...
    return (
        <section className='w-full bg-[#FBF6F1] py-16 md:py-24'>
            <div className='grid grid-cols-1 md:grid-cols-[1.5fr_2fr] gap-15 items-start max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 2xl:px-20'>
                {/* Left: Flower Image */}
                <div className='relative h-[400px] md:h-[500px] lg:h-[900px] order-1'>
                ...
                <div className='flex flex-col gap-8 order-2 '>
                    <h2 className='text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl font-medium text-[#223614] mb-10 mt-50'>
                        FAQs
                    </h2>
