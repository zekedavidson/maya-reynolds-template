    ...
    return (
        <section className="min-h-screen bg-background">
            <div className="pt-20 pb-20 px-6 md:px-12 lg:px-20 max-w-[1500px] mx-auto">
                <RevealOnScroll>
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#36575C] mb-8 text-center">
                        Our Office
                    </h1>

                    <div className="max-w-6xl mx-auto text-center mb-16 md:mb-24">
                        <p className="text-lg md:text-2xl text-[#36575C]/80 leading-relaxed font-[450]">
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-20">
                        ...
                        <div className="relative aspect-4/3 w-full bg-[#dcc5b4] overflow-hidden rounded-sm border-3 border-[#36575C]/70 flex items-center justify-center group">
                            <span className="text-[#36575C]/40 font-medium">Office Image 1</span>
                            {<Image
                                src="/office1.jpeg"
                        ...
                        {/* Image Placeholder 2 */}
                        <div className="relative aspect-4/3 w-full bg-[#dcc5b4] overflow-hidden rounded-sm border-3 border-[#36575C]/70 flex items-center justify-center group">
                            <span className="text-[#36575C]/40 font-medium">Office Image 2</span>
                            <Image
                                src="/office2.jpeg"
            ...
            <section className="w-full bg-[#bc722f] text-white py-20 px-6 md:px-12 lg:px-20">
                <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
                    ...
                    <div className="space-y-12">
                        <div>
                            <h2 className="text-4xl md:text-3xl font-medium mb-6">We look forward to welcoming you into this space.</h2>
                            <Link
                                href="/contact"
                        ...
                        <div>
                            <h3 className="text-3xl md:text-4xl font-medium mb-6">Hours</h3>
                            <p className="text-lg md:text-xl font-light leading-relaxed opacity-90">
                                Monday – Friday<br />
                                10am – 6pm
                            </p>
