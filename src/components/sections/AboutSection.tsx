...
const AboutSection = () => {
    return (
        <section className='w-full bg-[#E5E0DA] py-16 md:py-24 pb-32 md:pb-60 pl-8 md:pl-16 lg:pl-20'>
            <div className='grid grid-cols-1 md:grid-cols-[6fr_5fr] gap-12 items-center'>
                ...
                <div className='relative h-[500px] md:h-[600px] lg:h-[700px] w-full order-1'>
                    ...
                    <div className='absolute top-0 left-0 2xl:right-[40%] w-[280px] h-[420px] md:w-[380px] md:h-[580px] lg:w-[420px] lg:h-[630px] 2xl:w-[500px] 2xl:h-[770px] rounded-t-full overflow-hidden z-10'>
                        <Image
                    ...
                    <div className='absolute bottom-0 right-0 md:top-[55%] lg:top-[70%] lg:left-[45%] 2xl:left-[40%] 3xl:top-130 3xl:left-85 w-[220px] h-[220px] md:w-[260px] md:h-[260px] lg:w-[300px] lg:h-[300px] 2xl:w-[360px] 2xl:h-[360px] rounded-full overflow-hidden z-20'>
                        <Image
